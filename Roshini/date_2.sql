...
select PlayerName,Country,Role
from CricketPlayers;
...
select top 3 PlayerName, BattingAverage
from CricketPlayers
...
select count(*)Country,PlayerName
from CricketPlayers
group by PlayerName;
...
from CricketPlayers
where Battingaverage between 40 and 65
...
select PlayerName,Runs,Wickets
from CricketPlayers
where Runs > 3000 and Wickets > 50;
...
select top 5 Matches,PlayerName
from CricketPlayers
