...
create table Cricket_Players (
    Player_ID int,PlayerName Varchar(50), Country Varchar(30), Role Varchar(20), Matches int, Runs int, Wickets int, BattingAverage DECIMAL(5,2), BowlingAverage DECIMAL(5,2));
